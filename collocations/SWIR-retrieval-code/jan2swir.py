...
rootstart = time.time()
print("Program start (IST) = ",datetime.datetime.now(timezone("Asia/Kolkata")).strftime('%d-%M-%Y %H:%M:%S.%f'))
...
print("Program end (IST) = ",datetime.datetime.now(timezone("Asia/Kolkata")).strftime('%d-%M-%Y %H:%M:%S.%f'))
